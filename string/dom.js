...
// document.title = "nuran"
// const myHeader = document.getElementById("header")
// myHeader.style.background = "red"
// myHeader.style.color = "yellow"

// const myButon = document.getElementById("btn")
// myButon.style.padding = "1rem"
// myButon.style.color = "blue"

// const list = document.getElementsByTagName("li")
// list[0].style.color = "red"
// list[list.length-1].style.color = "purple"
// list[3].style.color = "magenta"
...
// list[3].innerHTML += `<p>Nuran</p>`
// list[2].innerHTML += `<h1>DOM</h1>`
